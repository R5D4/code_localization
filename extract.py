...
#
# EXTRACTION: to extract, we run this script as follows
#
#   $./translate.py -xr ./Parent ./temp py
#
# Note the 'r' in '-xr' stands for recursive. 
...
#               /File3.py.out
#
# TRANSLATION: now take your .out files and run them through Google translate
...
#
# INSERTION: after putting the translated .en files in the right place, run
# 
...
# NOTE: Ignore the above description since we're still implementing key
# features.
